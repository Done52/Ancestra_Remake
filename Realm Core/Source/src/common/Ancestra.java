...
public class Ancestra
{
	...
	public static String REALM_VERSION = "1.0.0";
	...
	{		
		...
		Realm.loadRealm();
		System.out.print("Creation du RealmServer sur le port "+Ancestra.REALM_PORT);
	...
	public static String makeHeader()
	{
		...
		mess.append("Ancestar Remake Realm v"+REALM_VERSION);
		mess.append("\nDevelopped by DeeZ \nCredit to DeahtDown,Falyptus@Keal");
		mess.append("\nhttp://ancestra.tk");
